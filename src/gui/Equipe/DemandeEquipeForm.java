 ...
 * @author fachr
 */
public class DemandeEquipeForm extends Form{  
    ...
    public void setUser(Utilisateur user) {
        this.user = user;
        System.out.println("USerrrr:"+user.getId());
         equips= ServiceInvitation.getInstance().getAllInvitation();
    ...
    public DemandeEquipeForm( Resources res){
...
public void actionPerformed(ActionEvent e){  
       rDemandeEquipeForm a = new rDemandeEquipeForm(res,text);
          a.setUser(user,text);
          a.show();
            refreshTheme();
...
public void actionPerformed(ActionEvent e){  
    ...
    private void addButton(Image img,Invitation get) {
        int height=Display.getInstance().convertToPixels(11.5f);
           ...
           image.setUIID("Label");
            Button valider=new Button("Accepter DEMANDE");
        valider.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                Invitation i =get;
                   if (new ServiceInvitation().UpdateInvitation(i)){
                            Dialog.show("Success","Invitation ACCEPTED", new Command("OK"));
                      }else{
...
if(get.getType().equals("demande") && get.getValide()==0&& get.getUtilisateur().getId()==user.getId()){
     cnt.add(ta);
   cnt.add(valider); 
   add(cnt);
}
