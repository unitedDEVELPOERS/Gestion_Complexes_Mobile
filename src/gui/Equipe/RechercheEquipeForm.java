 ...
 * @author fachr
 */
public class RechercheEquipeForm extends Form{
    ...
    public void setUser(Utilisateur user) {
     ...
     public RechercheEquipeForm(Resources res,String nom){
...
public void actionPerformed(ActionEvent e){  
 ...
 partage.addActionListener((e) -> {
       ...
       equips= ServicesEquipe.getInstance().getOneEquips(nom);
    ...
    private void addButton(Image img,Equipe get) {
        ...
        valider.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                Invitation i =new Invitation("request",e,user,0);
