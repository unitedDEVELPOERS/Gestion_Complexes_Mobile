...
public class ServiceReservation {
  public ArrayList<Reservation> reservations;
    ...
    public Reservation findReservation(String date, String heure){
      Reservation reservation = new Reservation();
    String url = Statics.BASE_URL+"/resJson/"+date+"/"+heure;
     req.setUrl(url);
        req.setPost(false);
         req.addResponseListener(new ActionListener<NetworkEvent>(){
        @Override
        public void actionPerformed(NetworkEvent evt) {
            try {
                JSONParser j=new JSONParser();
                Map<String,Object> ReservationJson=j.parseJSON(new CharArrayReader(new String(req.getResponseData()).toCharArray()));
             float id =Float.parseFloat(ReservationJson.get("id").toString());
